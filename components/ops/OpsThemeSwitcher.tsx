...
export default function OpsThemeSwitcher() {
  ...
  return (
    <div ref={rootRef} className="relative h-7 w-7">
      <button
        type="button"
        disabled={!mounted}
      ...
      {open ? (
        <div className="absolute bottom-full right-0 z-20 mb-2 w-max min-w-[150px] overflow-hidden rounded-xl border border-zinc-200 bg-white px-1 py-1 shadow-lg">
